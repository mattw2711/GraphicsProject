...
int main()
{
    ...
    // -------------------------
    Shader lightingShader("res/shaders/vertex.shader", "res/shaders/fragment.shader");
    Shader lightCubeShader("res/shaders/cubeLight.vs", "res/shaders/cubeLight.fs");
